...
function createCash() {
  if (World.frameCount % 120 == 0) {
   // Modify the positions of cash 
    var cash = createSprite(850,Math.round(random(50, 350),40, 10, 10));
...
function createDiamonds() {
  if (World.frameCount % 180 == 0) {
    ...
    var diamonds = createSprite(1200,Math.round(random(50, 350),40, 10, 10));
...
function createJwellery() {
  if (World.frameCount % 400 == 0) {
    ...
    var jwellery = createSprite(550,Math.round(random(50, 350),40, 10, 10));
...
function createSword(){
  if (World.frameCount % 280 == 0) {
    ...
    var sword = createSprite(400,Math.round(random(50, 350),40, 10, 10));
